                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="add-lembur.php" class="pull-right btn btn-inverse btn-sm waves-effect waves-light">Add</a>
                                        ...
                                        <tbody>
                                        		<?php
                                                  ...
                                                  $pengeluaran = $data['pengeluaran'];
                                                   ...
                                                   echo "<td>";
                                                   echo "<a href='edit-lembur.php?id=".$data['id']."'> Edit </a> |";
                                                   echo "<a href='delete-lembur.php?id=".$data['id']."'> Hapus </a>";
                                                   echo "</td>";
                                        ...
                                        <tfoot>
                                          <tr>
                                              <td colspan="8">
                                                                                  ...
                                                                                  <?php
                                                                                  $sql = mysqli_query($db, "SELECT sum(pengeluaran) AS pengeluaran FROM lembur")or die(mysqli_error($db));
