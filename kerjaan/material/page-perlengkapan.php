                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="add-perlengkapan.php" class="pull-right btn btn-inverse btn-sm waves-effect waves-light">Add</a>
                                        ...
                                        <tbody>
                                        		<?php
                                                 ...
                                                 $pengeluaran = $data['pengeluaran'];
                                                   ...
                                                   echo "<td>";
                                                   echo "<a href='edit-perlengkapan.php?id=".$data['id']."'> Edit </a> |";
                                                   echo "<a href='delete-perlengkapan.php?id=".$data['id']."'> Hapus </a>";
                                                   echo "</td>";
                                        ...
                                        <tfoot>
                                          <tr>
                                              <td colspan="8">
                                                                                  ...
                                                                                  <?php
                                                                                  $sql = mysqli_query($db, "SELECT sum(pengeluaran) AS pengeluaran FROM perlengkapan")or die(mysqli_error($db));
