                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="add-sppd.php" class="pull-right btn btn-inverse btn-sm waves-effect waves-light">Add</a>
                                        ...
                                        <tbody>
                                        		<?php
                                                 ...
                                                 $pengeluaran = $data['pengeluaran'];
                                                   ...
                                                   echo "<td>";
                                                   echo "<a href='edit-sppd.php?id=".$data['id']."'> Edit </a> |";
                                                   echo "<a href='delete-sppd.php?id=".$data['id']."'> Hapus </a>";
                                                   echo "</td>";
                                        ...
                                        <tfoot>
                                          <tr>
                                              <td colspan="8">
                                                                                  ...
                                                                                  <?php
                                                                                  $sql = mysqli_query($db, "SELECT sum(pengeluaran) AS pengeluaran FROM sppd")or die(mysqli_error($db));
